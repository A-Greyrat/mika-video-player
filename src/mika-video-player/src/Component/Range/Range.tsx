...
const Range = memo(
  forwardRef((props: RangeProps, ref: React.Ref<HTMLDivElement>) => {
    const {
      value,
      onChange,
      orient = 'horizontal',
    ...
    return (
      <div className={`mika-range ${className ?? ''}`} style={{ width, height }} ref={ref} {...rest}>
        <div className='mika-range-track-background' onPointerDown={handlePointerDown} ref={trackRef} />

        <div
          className='mika-range-track'
          ...
          style={
            {
              ...
              transform: `${
                orient === 'horizontal' ? `scaleX(${value / max})` : `scaleY(${value / max})`
