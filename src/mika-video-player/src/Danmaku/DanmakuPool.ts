...
import {DanmakuAttr, DanmakuTypeMap} from "./DanmakuType.ts";
...
export class DanmakuPool {
    ...
    displayAreaRate: 0.25 | 0.5 | 0.75 | 1 = 0.5;
    fontSizeScale = 1;
    ...
    private createDanmakuElement(danmaku: DanmakuAttr, danmakuParam: DanmakuParam) {
    ...
    private getDanmakuOption(danmaku: DanmakuAttr, delay: number): Omit<DanmakuOption, ContainerOption> {
